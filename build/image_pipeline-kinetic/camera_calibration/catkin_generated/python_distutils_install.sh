...
echo_and_run cd "/home/kentuen/ros_ws/src/image_pipeline-kinetic/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kentuen/ros_ws/src/image_pipeline-kinetic/camera_calibration/setup.py" \
     \
    build --build-base "/home/kentuen/ros_ws/build/image_pipeline-kinetic/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
