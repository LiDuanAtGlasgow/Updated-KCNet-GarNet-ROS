...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CropDecimateConfig::AbstractParamDescriptionConstPtr(new CropDecimateConfig::ParamDescription<int>("interpolation", "int", 0, "Sampling algorithm", "{'enum_description': 'interpolation type', 'enum': [{'srcline': 21, 'description': 'Nearest-neighbor sampling', 'srcfile': '/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'NN'}, {'srcline': 22, 'description': 'Bilinear interpolation', 'srcfile': '/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Linear'}, {'srcline': 23, 'description': 'Bicubic interpolation over 4x4 neighborhood', 'srcfile': '/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Cubic'}, {'srcline': 24, 'description': 'Resampling using pixel area relation', 'srcfile': '/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Area'}, {'srcline': 25, 'description': 'Lanczos interpolation over 8x8 neighborhood', 'srcfile': '/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Lanczos4'}]}", &CropDecimateConfig::interpolation)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 21 "/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_NN = 0;
//#line 22 "/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_Linear = 1;
//#line 23 "/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_Cubic = 2;
//#line 24 "/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_Area = 3;
//#line 25 "/home/kentuen/ros_ws/src/image_pipeline-kinetic/image_proc/cfg/CropDecimate.cfg"
